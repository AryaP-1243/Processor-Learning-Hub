...
export const MemoryStickIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M8 11V9a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
        <path d="M4 11.5a2.5 2.5 0 0 1 0-5A2.5 2.5 0 0 1 4 2"/>
        <path d="M20 11.5a2.5 2.5 0 0 0 0-5A2.5 2.5 0 0 0 20 2"/>
        <path d="M2.5 14H2v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5h-.5"/>
    </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 2a7 7 0 0 0-7 7c0 3.03 1.09 5.48 2.68 7.13L12 22l4.32-5.87C17.91 14.48 19 12.03 19 9a7 7 0 0 0-7-7z"/>
    </svg>
);
...
export const ProjectsIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <rect x="2" y="6" width="20" height="8" rx="1"/><path d="M10 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
        <path d="M6 14v4"/><path d="M18 14v4"/><path d="M10 14v4"/><path d="M14 14v4"/>
    </svg>
);

export const InterviewPrepIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const BugIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 20v-9"/>
        <path d="M6.53 9C4.6 9 3 7.4 3 5.47"/>
        <path d="M21 5.47c0 1.93-1.6 3.53-3.53 3.53"/>
    </svg>
);
